...
struct snapshot {
    ...
    void add_p2pkh (p2pkh entry) {
        header.p2sh_offset += sizeof(p2pkh);
        header.multisig_offset += sizeof(p2pkh);
        header.raw_script_offset += sizeof(p2pkh);
...
int main(int argc, char** argv) {
    ...
    //snapshot_bin.write((char*)&snapshot, sizeof(snapshot));
